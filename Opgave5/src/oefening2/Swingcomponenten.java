...
public class Swingcomponenten {
	...
	private JPanel smallPanel1, smallPanel2, smallPanel3, smallPanel4, verySmallPanel;
	...
	private Component getSmallPanel1() {
		if(smallPanel1==null) {
	...
	private Component getSmallPanel2() {
		if(smallPanel2==null) {
	...
	private Component getSmallPanel3() {
		if(smallPanel3==null) {
	...
	private Component getSmallPanel4() {
		if(smallPanel4==null) {
	...
	private Component getVerySmallPanel() {
